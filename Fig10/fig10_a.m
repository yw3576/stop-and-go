load('TIFS_insurance_reg_speed-clean_01.mat')
%%
pos_total=pos_total_s(2:4001,:);
veh_total=speed_total_s(2:4001,:);
pos_total=pos_total';
veh_total=veh_total';
x_plot_1=[];
pos_plot_1=[];
...
figure
for i=1:21
    plot(speed_total_s(:,i),'color',[0.7 0.7 0.7])
    hold on
end
plot(speed_total_s(:,1),'r')
